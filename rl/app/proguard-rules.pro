...
#不混淆语音实现类
-keep class * implements com.ubtrobot.led.ILedContext

#总线不混淆
-keep class com.ubtrobot.concurrent.** {*;}
-keep class com.ubtrobot.master.service.** {*;}
-keep class com.ubtrobot.transport.** {*;}


#总线注解修饰的类不混淆
-keep @com.ubtrobot.master.annotation.Call class * {*;}
-keep @com.ubtrobot.master.annotation.MasterService class * {*;}
...
-keep class com.ubtrobot.alphaserial.jni.SerialPortFile { *;}
# jni 相关 --end
