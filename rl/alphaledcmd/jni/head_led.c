...
JNIEXPORT jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_open(JNIEnv* env,jobject thiz)
{
    if(led_fd<=0)
...
JNIEXPORT jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_close(JNIEnv* env,jobject thiz)
{
  int result;
...
JNIEXPORT jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_ledSetOFF(JNIEnv* env,jobject thiz, jint val)
{
  int result;
  int value;
...
JNIEXPORT jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_ledSetOn(JNIEnv* env,jobject thiz, jint val)
{
  int result;
  int value;
...
JNIEXPORT jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_ledSetEye(JNIEnv* env, jobject thiz,
...
JNIEXPORT jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_ledSetHead(JNIEnv* env, jobject thiz,
		jint rgb,jint brightness,jint reye,jint leye,jint on,jint off,jint total,jint state)
{
  int result;
  struct led_eye_set_hal *peyes;
...
JNIEXPORT jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_ledSetMouth(JNIEnv* env,jobject thiz,jint brightness,jint on,jint off,jint total,jint state)
{
  int result;
  struct led_eye_set_hal *peyes;
...
jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_keySetSens(JNIEnv* env,jobject thiz,jint key1,jint key2)
{
  int result;
...
jboolean JNICALL Java_com_ubtrobot_ledcmds_jni_LedControl_keyReadSens(JNIEnv* env,jobject thiz,jint *key1,jint *key2)
{
  int result;
  struct key_sens_set_hal *pkey;
